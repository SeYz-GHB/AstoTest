...
import { GiUsbKey, GiJackPlug } from "react-icons/gi";
...
const HeadphonesList = ({ data, basePath = 'headphones' }) => {
            ...
            <div className="w-full flex flex-col items-center gap-2">
              <div className="flex justify-between w-full items-center">
                <img
                  ...
                  alt={`${eachData.brand} logo`}
                  className="w-[25%] object-contain self-start"
                />
                <div className="flex items-center gap-[5px] my-1 text-[0.9rem] md:text-xl">
              ...
              <div className='h-[80%] flex justify-center items-center'>
                  ...
                  src={eachData.image}
                  alt={eachData.name}
                  className="h-[80%] md:h-[90%] object-contain w-full"
                />
              </div>
            </div>
